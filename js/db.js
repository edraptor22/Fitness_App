...
const DB_VERSION = 4;   // v2 weights+quotes; v3 habits+nutrition; v4 urges
export const STORES = ['settings', 'exercises', 'plans', 'workouts', 'sessions', 'weights', 'quotes', 'habits', 'nutrition', 'urges'];
